...
async def test__news_org_api_client_init__creates_underlying_client(
    mocked_newsapi_client,
    config
) -> None:
    """Test NewsOrgApiClient initialization creates underlying client."""
    api_key = 'test-api-key'
    client = NewsOrgApiClient(api_key)
...
async def test__get_top_headlines__with_sources_excludes_country(
    ...
    result = news_client.get_top_headlines(sources='bbc-news,cnn', country='us')
...
async def test__get_top_headlines__handles_exception(
    news_client: NewsOrgApiClient
) -> None:
...
async def test__search_articles__success_with_dates(
    ...
    result = news_client.search_articles(
...
async def test__search_articles__handles_exception(
    news_client: NewsOrgApiClient
) -> None:
...
async def test__get_sources__success_with_filters(
    ...
    news_client._client.get_sources.assert_called_once_with(
        category='technology',
        country='us',
        language='en'
    )
...
async def test__get_sources__handles_exception(
    news_client: NewsOrgApiClient
) -> None:
...
async def test__handle_response__with_success_status(
    news_client: NewsOrgApiClient
) -> None:
...
async def test__handle_response__with_api_error_status(
    news_client: NewsOrgApiClient
) -> None:
...
async def test__handle_response__with_unknown_error_format(
    news_client: NewsOrgApiClient
) -> None:
...
async def test__handle_error__formats_exception_message(
    news_client: NewsOrgApiClient
) -> None:
